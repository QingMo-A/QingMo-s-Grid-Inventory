...
public final class ModDataComponents {
    public static final Supplier<DataComponentType<GridInventoryData>> GRID_INVENTORY = registry().registerDataComponent(
            "grid_inventory",
    ...
    public static final Supplier<DataComponentType<EquipmentStorageData>> EQUIPMENT_STORAGE = registry().registerDataComponent(
            "equipment_storage",
    ...
    public static final Supplier<DataComponentType<Boolean>> BACKPACK_FOLDED = registry().registerDataComponent(
            "backpack_folded",
    ...
    private static NeoForgeGridInventoryRegistryBridge registry() {
        return (NeoForgeGridInventoryRegistryBridge) GridInventoryServices.registry();
    }
}
