...
public final class Forge1201ServerConfig {
    private static final ForgeConfigSpec.Builder BUILDER = new ForgeConfigSpec.Builder();

    public static final ForgeConfigSpec.BooleanValue ENABLE_GRID_INVENTORY;
    public static final ForgeConfigSpec.IntValue DEFAULT_ITEM_WIDTH;
    public static final ForgeConfigSpec.IntValue DEFAULT_ITEM_HEIGHT;
    public static final ForgeConfigSpec.BooleanValue DEFAULT_ROTATABLE;
    public static final ForgeConfigSpec.BooleanValue GRID_ITEMS_STACKABLE;
    public static final ForgeConfigSpec.IntValue MAX_NESTED_BACKPACK_DEPTH;
    public static final ForgeConfigSpec.IntValue SMALL_GRID_BAG_COLUMNS;
    public static final ForgeConfigSpec.IntValue SMALL_GRID_BAG_ROWS;
    public static final ForgeConfigSpec.BooleanValue REPLACE_SURVIVAL_INVENTORY;
    public static final ForgeConfigSpec.IntValue PLAYER_GRID_COLUMNS;
    public static final ForgeConfigSpec.IntValue PLAYER_GRID_ROWS;
    public static final ForgeConfigSpec.BooleanValue POCKET_ENABLED;
    public static final ForgeConfigSpec.IntValue POCKET_COLUMNS;
    public static final ForgeConfigSpec.IntValue POCKET_ROWS;
    public static final ForgeConfigSpec.BooleanValue EQUIPMENT_STORAGE_ENABLED;
    public static final ForgeConfigSpec.IntValue FOLDED_BACKPACK_WIDTH;
    public static final ForgeConfigSpec.IntValue FOLDED_BACKPACK_HEIGHT;
    public static final ForgeConfigSpec.BooleanValue ALLOW_CHEST_STORAGE;
    public static final ForgeConfigSpec.BooleanValue ALLOW_LEGS_STORAGE;
    public static final ForgeConfigSpec.BooleanValue CUSTOM_HOTBAR_SLOTS_ENABLED;
    public static final ForgeConfigSpec.IntValue HOTBAR_SLOTS;
    public static final ForgeConfigSpec.BooleanValue DISABLE_VANILLA_AUTO_PICKUP;
    public static final ForgeConfigSpec.BooleanValue MANUAL_PICKUP_ENABLED;
    public static final ForgeConfigSpec.DoubleValue PICKUP_RANGE;
    public static final ForgeConfigSpec.DoubleValue NEARBY_ITEMS_RANGE;
    public static final ForgeConfigSpec.BooleanValue ALLOW_PICKUP_THROUGH_WALLS;
    public static final ForgeConfigSpec.BooleanValue SERVER_VALIDATE_NEARBY_RANGE;
