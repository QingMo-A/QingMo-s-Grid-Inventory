...
public final class GridUiLayers {
    ...
    public static final float EQUIPMENT_TOOLTIP_ITEM_OFFSET = 10.0F;
    public static final float EQUIPMENT_TOOLTIP_ITEM = EQUIPMENT_TOOLTIP + EQUIPMENT_TOOLTIP_ITEM_OFFSET;
    ...
    public static final float NESTED_WINDOW_TOOLTIP_ABOVE_WINDOW = 40.0F;
    ...
    public static float nestedWindowTooltipZ(float topNestedWindowZ) {
        return Math.min(topNestedWindowZ + NESTED_WINDOW_TOOLTIP_ABOVE_WINDOW, VANILLA_TOOLTIP - 100.0F);
    }
