...
public final class GridItemSizeManager {
    ...
    public static GridItemSize defaultSize() {
        return new GridItemSize(GridInventoryServices.config().defaultItemWidth(), GridInventoryServices.config().defaultItemHeight(), GridInventoryServices.config().defaultRotatable());
    }
